...
<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
	...
	<?php do_atomic( 'open_entry' ); // my-life_open_entry ?>
		...
		<?php if ( is_singular() ) 
			echo apply_atomic_shortcode( 'entry_meta', '<div class="entry-meta">' . __( '[post-format-link] published on [entry-published] [entry-edit-link before="| "]<br />[entry-terms taxonomy="category" before="Posted in "] [entry-terms before="| Tagged "]', 'my-life' ) . '</div>' );
		else
